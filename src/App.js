...
firebase.initializeApp({
  apiKey: "AIzaSyDZ1g7vTHyVGDPGsLghevrYeK1WSkWTWJE",
  authDomain: "chatbox-329f7.firebaseapp.com",
  projectId: "chatbox-329f7",
  storageBucket: "chatbox-329f7.appspot.com",
  messagingSenderId: "526512307368",
  appId: "1:526512307368:web:ff45af5e4f55cef6b7569d",
});
...
function App() {
  ...
  //   ? `${process.env.PUBLIC_URL}/owl.svg`
  // owl logo isnt used any more , open peeps looks more cool, switch later
  //   : `${process.env.PUBLIC_URL}/owl.svg`;
        ...
        <div className="flex flex-col items-center justify-center max-w-xl w-full mx-4 p-8 rounded-md shadow-card bg-white dark:bg-coolDark-600 transition-all">
          <h2 className="mb-2 text-3xl flex items-center">
            <img
              ...
              src={process.env.PUBLIC_URL + "/Open Peeps - Bust.png"} alt="chat-bot"
            />
            <br />
            Chat Palace
          </h2>
          <p className="mb-8 text-lg text-center">
            Chat the universe by your almighty fingers
          </p>
          <button
  ...
  return (
    <div className="flex flex-col h-full bg-white dark:bg-coolDark-500 dark:text-white transition-colors">
      ...
      >
        <a href="https://nteasocial.com">
          <img
            style={{ width: "150px", height: "90px" }}
            src={process.env.PUBLIC_URL + "Beep Beep - Bus.png"}
            alt="Shivani | Nteasocial"
            // width={150}
            // height={70}
          />
        </a>
